...
<img src="../images/<?php echo $row['url']; ?>" id="anh_dai_dien" alt="">
<?php }?>
<script>
...
<img src="../images/<?php echo $row['url']; ?>" class="rounded-circle border" alt="">
<?php }
            break;
